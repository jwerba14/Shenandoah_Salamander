...
load("./ModelOutput/first_5yrs_out.rda")
load("./ModelOutput/first_6yrs_out.rda")
load("./ModelOutput/first_7yrs_out.rda")
load("./ModelOutput/first_8yrs_out.rda")   # NOT CONVERGED - short run
load("./ModelOutput/first_9yrs_out.rda")   # NOT CONVERGED - short run

# If downloaded - you will need to creat the objects in each section ( 3 - 9) but don't run the models
