...
## Repeat the first column 10 times because that is how the data were analyzed
for(i in 1:10){

std_temp2 <- cbind(std_temp2[,1], std_temp2)
std_rmi2 <- cbind(std_rmi2 [,1], std_rmi2)
}
}
...
# First year of data collection = 2007
  # Last year of data collection = 2016
  # + 60 year projection = 2076
# n.project = 70
...
if(length(which(name1 == "Abiotic")) == 1){
  ...
  # Set parameter values
  alpha.psiS  <- abiotic_biotic$sims$alpha.psiSc[n.MCMC]
  alpha.psiC  <- abiotic_biotic$sims$alpha.psiC[n.MCMC]
  alpha.survS <- abiotic_biotic$sims$alpha.survAloneS[n.MCMC]
  alpha.colS  <- abiotic_biotic$sims$alpha.colEmptyS[n.MCMC]
  beta.survS1 <- abiotic_biotic$sims$beta.survAloneS1[n.MCMC]
  beta.colS1  <- abiotic_biotic$sims$beta.colEmptyS1[n.MCMC]
  beta.survS2 <- abiotic_biotic$sims$beta.survAloneS2[n.MCMC]
  beta.colS2  <- abiotic_biotic$sims$beta.colEmptyS2[n.MCMC]
  alpha.survC <- abiotic_biotic$sims$alpha.survAloneC[n.MCMC]
  alpha.colC  <- abiotic_biotic$sims$alpha.colEmptyC[n.MCMC]
  beta.survC1 <- abiotic_biotic$sims$beta.survAloneC1[n.MCMC]
  beta.colC1  <- abiotic_biotic$sims$beta.colEmptyC1[n.MCMC]
  beta.survC2 <- abiotic_biotic$sims$beta.survAloneC2[n.MCMC]
  beta.colC2  <- abiotic_biotic$sims$beta.colEmptyC2[n.MCMC]
